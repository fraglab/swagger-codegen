...
public class Game01codegenGenerator extends DefaultCodegen implements CodegenConfig {

    public static final String DECLSPEC = "declspec";
    public static final String DEFAULT_INCLUDE = "defaultInclude";    
    public static final String GENERATE_MODEL_NAMES = "generateModelNames";

    protected String packageVersion = "1.0.0";
    protected String declspec = "";
    protected String defaultInclude = "";
    protected String invokerPackage = "io.swagger.client";
    protected boolean shouldGenerateModelNames = false;
    ...
    public Game01codegenGenerator() {
        ...
        embeddedTemplateDir = templateDir = "Game01Codegen";
        ...
        supportingFiles.add(new SupportingFile("httprequestinfo-header.mustache", "", "HttpRequestInfo.h"));
        ...
        supportingFiles.add(new SupportingFile("requestTask-header.mustache", "", "RequestTask.h"));
        ...
        importMapping.put("HttpRequestInfo", "#include \"HttpRequestInfo.h\"");
        importMapping.put("RequestTask", "#include \"RequestTask.h\"");
    ...
    public void processOpts() {
        ...
        if (additionalProperties.containsKey(GENERATE_MODEL_NAMES)) {
            shouldGenerateModelNames = Boolean.valueOf(additionalProperties.get(GENERATE_MODEL_NAMES).toString());
        }

        additionalProperties.put(GENERATE_MODEL_NAMES, shouldGenerateModelNames);
    }
        ...
        if (operation.getResponses() != null && !operation.getResponses().isEmpty()) {
            ...
            if (methodResponse != null) {
                if (methodResponse.getSchema() != null) {
                    ...
                    op.vendorExtensions.put("x-codegen-response-isPlainObject", cm.complexType.equals("Object"));
                }
            }
        }
    ...
    public String toModelName(String type) {
        if (typeMapping.keySet().contains(type) || typeMapping.values().contains(type)
            ...
            final String sanitizedName = sanitizeName(type);
